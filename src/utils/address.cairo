...
pub fn compute_contract_address(deployerAddress: ContractAddress, salt: felt252, class_hash: ClassHash, calldata: Array<felt252>) -> ContractAddress {
  ...
  let account_address_felt = computeHashOnElements(array![CONTRACT_ADDRESS_PREFIX, deployerAddress_felt, salt, class_hash_felt, calldata_hash]);
