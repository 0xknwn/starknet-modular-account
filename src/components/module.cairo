...
mod tests {
    ...
    fn test_authz_hash() {
        ...
        let hash = authz_hash(account_address, account_class, authorized_key, expires, merkle_root, chain_id);
        assert_eq!(hash, 0x4bf9baea6574851c9a8156450442e8db4de44284bba58ab79e634380e3fd294, "value should match");
    }
}
