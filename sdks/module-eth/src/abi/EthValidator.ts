export const ABI = [
  ...
  },
  {
    "type": "impl",
    "name": "PublicKey",
    "interface_name": "smartr::modules::ethvalidator::ethvalidator::IPublicKey"
  },
  {
    "type": "interface",
    "name": "smartr::modules::ethvalidator::ethvalidator::IPublicKey",
    "items": [
      {
        "type": "function",
        "name": "set_public_key",
  ...
  {
    "type": "event",
    "name": "smartr::modules::ethvalidator::ethvalidator::EthValidator::Event",
    "kind": "enum",
    "variants": [
      {
        "name": "ValidatorEvent",
