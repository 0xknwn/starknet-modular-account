export const ABI = [
  ...
  },
  {
    "type": "impl",
    "name": "PublicKey",
    "interface_name": "smartr::modules::p256validator::p256validator::IPublicKey"
  },
  {
    "type": "interface",
    "name": "smartr::modules::p256validator::p256validator::IPublicKey",
    "items": [
      {
        "type": "function",
        "name": "set_public_key",
        "inputs": [
          {
            "name": "new_public_key",
            "type": "core::starknet::secp256r1::Secp256r1Point"
          }
        ],
        "outputs": [],
        "state_mutability": "external"
  ...
  {
    "type": "event",
    "name": "smartr::modules::p256validator::p256validator::P256Validator::Event",
    "kind": "enum",
    "variants": [
      {
        "name": "ValidatorEvent",
