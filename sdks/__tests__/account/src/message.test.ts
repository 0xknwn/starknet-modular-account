...
import { hash_auth_message } from "@0xknwn/starknet-modular-account";
...
describe("message management", () => {
  ...
  it("computes the hash with hash_auth_message", async () => {
    ...
    expect(code).toBe(
      `0x${3607702933816136767961445235909759424846066858635070681944709519388181433692n.toString(
        16
      )}`
    );
  });
